...
<h2>Shopping Cart</h2>
	...
	<table>
		...
		<c:forEach var="cartItem" items="${cart.cartItems}">
			<tr>
                ...
                <td>
                    <a href="/cart/remove/item?itemId=${cartItem.item.itemId}" class="Button">
                        Remove
                    </a>
                </td>
		...
		<tr>
			<td colspan="7">Sub Total: $<fmt:formatNumber
				value="${cart.subTotal}" pattern="#,##0.00" /> <form action="cart" method="post" style="display:inline;">
	...
	<c:if test="${cart.numberOfItems > 0}">
		<a class="Button" href="/order/newOrderForm">Proceed to Checkout</a>
	</c:if></div>
